...
THREATS = [
    ...
    Threat("pdn_leak", "Утечка персональных данных", ["personal_data", "crm", "cloud"], "org_legal", 0.18, 0.36, 2.10, "Правовой, репутационный и восстановительный ущерб."),
    ...
    Threat("legal_gap_pdn", "Правовой разрыв в обработке персональных данных", ["personal_data", "website", "employees"], "org_legal", 0.46, 0.26, 1.60, "Отсутствие документов, уведомлений, оснований обработки, договоров и процедур."),
...
CONTROLS = [
    ...
    Control("pdn_compliance", "Правовой комплект ПДн: политика, основания, уведомления, договоры", "org_legal", "legal_compliance", 65000, ["legal_gap_pdn", "pdn_leak"], 0.35, 0.42, 0.00),
    Control("incident_procedure", "Процедура реагирования на инциденты и утечки", "org_legal", "detection", 32000, ["pdn_leak", "legal_gap_pdn", "ransomware"], 0.14, 0.32, 0.20),
    Control("employee_training", "Практическое обучение сотрудников фишингу и работе с данными", "org_legal", "preventive", 24000, ["phishing_email", "insider_leak", "pdn_leak"], 0.24, 0.15, 0.00),
    ...
    Control("crisis_fund", "Резерв затрат на восстановление после ИБ-инцидента", "economic_management", "recovery", 80000, ["ransomware", "pdn_leak", "website_outage", "supplier_failure"], 0.00, 0.34, 0.18),
]
...
SECTOR_PROFILES = {
    "Розничная торговля": {"email": .70, "website": .45, "pos": 1.00, "crm": .65, "personal_data": .70, "cloud": .55, "bank": .85, "employees": .70},
    "Интернет-магазин": {"email": .85, "website": 1.00, "pos": .70, "crm": .90, "personal_data": .90, "cloud": .85, "bank": .80, "employees": .75},
    "Услуги": {"email": .80, "website": .65, "pos": .75, "crm": .75, "personal_data": .80, "cloud": .65, "bank": .70, "employees": .75},
    "B2B-компания": {"email": .95, "website": .55, "pos": .25, "crm": .90, "personal_data": .65, "cloud": .80, "bank": .85, "employees": .85},
    "Производство": {"email": .75, "website": .45, "pos": .20, "crm": .60, "personal_data": .55, "cloud": .55, "bank": .75, "employees": .80},
    "Медицина / образование": {"email": .85, "website": .70, "pos": .50, "crm": .75, "personal_data": 1.00, "cloud": .80, "bank": .65, "employees": .85},
}
